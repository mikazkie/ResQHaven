    ...
    <div>
      ...
      <div
        className='d-flex align-items-center
          gap-2 p-3 rounded-4 border mb-3 admin-form-soft-block'
        style={{
          ...
          return (
            <div key={s.value}
              ...
              style={{
                ...
                borderColor: isSelected ? '#fca5a5' : '#dbe4f0',
      ...
      {/* Summary */}
      {selected.length > 0 && (
        <div className='mt-3 p-3 rounded-4 border'
        ...
        >
          ...
          <div className='d-flex flex-wrap gap-1'>
            {selected.map(s => {
              ...
              return (
                <span key={s}
                  className='badge text-dark border rounded-pill px-3 py-2'
  ...
  return (
    <div className='admin-form-page'>
      ...
      <div className='admin-form-header'>
        <div>
        <div className='admin-form-kicker'>Family Intake</div>
      ...
      {step === 1 && (
        <div className='card border-0 shadow-sm'>
          <div className='card-body p-4'>
            ...
            <div className='admin-form-section'>Find Head of Family</div>

            {!head ? (
              <>
                {!headType && (
                  <div className='admin-form-mode-grid mt-4 mb-3'>
                    <button
                      type='button'
                    ...
                    >
                      ...
                      <h6 className='fw-bold mb-2'>Search Registered User</h6>
                      <p className='text-muted mb-0'>
                        Find the head of family by name or phone number.
                      </p>
                    </button>
                    <button
                      type='button'
                    ...
                    >
                      ...
                      <h6 className='fw-bold mb-2'>Register New Head</h6>
                      <p className='text-muted mb-0'>
                        Create a new evacuee record and continue the family intake manually.
                      </p>
                    </button>
                  </div>
                )}
